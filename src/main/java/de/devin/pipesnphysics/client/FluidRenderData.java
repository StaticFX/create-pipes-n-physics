...
/**
 * Data records used by mixins to pass groups of related values between helper methods.
 * Kept outside the mixin package because Sponge Mixin does not allow inner classes
 * of a mixin to be loaded as standalone classes.
 */
